...
public class RobotContainer {
  ...
  public RobotContainer() {
    String trajectoryJSON = "paths/output/Course1.wpilib.json";
  ...
  private Command generateRamseteCommand() {
    ...
    return new InstantCommand(() -> m_drivetrain.resetOdometry(m_trajectory.getInitialPose()), m_drivetrain)
  ...
  private void configureButtonBindings() {
    ...
    m_LBBtn = new JoystickButton(m_controller, 6);
    m_LBBtn.whileHeld(new IntakeCommand(m_intake));
